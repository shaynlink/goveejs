...
export default {
  ...
  // Indicates whether the coverage information
  // should be collected while executing the test
  ...
  // Force coverage collection from ignored files using
  ...
  // to arrays of module names that allow to stub out
  ...
  // An array of regexp pattern strings that are matched against
  // all modules before the module loader will automatically
